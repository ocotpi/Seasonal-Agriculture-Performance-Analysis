...
[![Jupyter Notebook](https://img.shields.io/badge/Notebook-Data__Visualization.ipynb-orange.svg)](Data_Visualization.ipynb)
[![PowerPoint Deck](https://img.shields.io/badge/Presentation-seasonal__agriculrural__analysis.pptx-red.svg)](seasonal_agriculrural_analysis.pptx)
...
## 📖 Executive Summary
Agriculture across India is structurally governed by three agro-meteorological seasons: **Kharif (Monsoon)**, **Rabi (Winter)**, and **Zaid (Summer)**. In this major project, I conducted an empirical investigation on **4,000 multi-state farm observations** spanning **8 states** and **8 major crops** (Wheat, Rice, Maize, Pulses, Cotton, Groundnut, Sugarcane, Chilli).
...
```text
Seasonal-Agriculture-Performance-Analysis/
├── Data_Visualization.ipynb             # Complete Jupyter Notebook with code, charts, and statistical tests
├── seasonal_agriculrural_analysis.pptx   # Official 14-Slide PowerPoint Presentation Deck
...
```
*Or upload `Data_Visualization.ipynb` directly into [Google Colab](https://colab.research.google.com/).*
